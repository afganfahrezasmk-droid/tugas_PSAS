...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2025 at 02:16 AM
...
CREATE TABLE `kendaraan` (
  ...
  `kendaraan_nama` varchar(100) NOT NULL,
  `kendaraan_tipe` varchar(50) NOT NULL,
...
--
ALTER TABLE `kendaraan`
  MODIFY `kendaraan_nomor` int(20) NOT NULL AUTO_INCREMENT;
